...
class ViewSalle:
    def __init__(self):
        ...
        self.label_cat = ctk.CTkLabel(self.frame_info, text="Categories :")
        ...
        self.label_cap = ctk.CTkLabel(self.frame_info, text="capacities :")
        ...
        self.btn_ajouter.grid(row=0, column=0, padx=10, pady=5)


        self.btn_modifier = ctk.CTkButton(self.frame_action, text="Modifier")
        self.btn_modifier.grid(row=0, column=1, padx=10, pady=5)

        self.btn_supprimer = ctk.CTkButton(self.frame_action, text="Supprimer")
        self.btn_supprimer.grid(row=0, column=2, padx=10, pady=5)
